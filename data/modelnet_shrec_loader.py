    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            if self.opt.rot_horizontal:
                pc_np, surface_normal_np, som_node_np = rotate_point_cloud_up_with_normal_som(pc_np, surface_normal_np, som_node_np)
            if self.opt.rot_3d:
                pc_np, surface_normal_np, som_node_np = rotate_point_cloud_3d_with_normal_som(pc_np, surface_normal_np, som_node_np)
