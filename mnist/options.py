...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--dataset', type=str, default='mnist', help='modelnet / shrec / shapenet')
        self.parser.add_argument('--dataroot', default='/ssd/jiaxin/dataset/mnist-rot/som_intensity_thre_0.39', help='path to images & laser point clouds')
        ...
        self.parser.add_argument('--input_pc_num', type=int, default=512, help='# of input points')
        self.parser.add_argument('--intensity', type=bool, default=True, help='use intensity in the MNIST image')
        ...
        self.parser.add_argument('--node_num', type=int, default=16, help='som node number')
        ...
        self.parser.add_argument('--som_k', type=int, default=4, help='k nearest neighbor of SOM nodes searching on SOM nodes')
        ...
        self.parser.add_argument('--rot_equivariant_pooling_mode', type=str, default='global', help='global, per-hierarchy')
        self.parser.add_argument('--rot_equivariant_mode', type=str, default='2d', help='2d, 3d (cube group, tetrahedral group, klein 4-group)')
        self.parser.add_argument('--rot_equivariant_no', type=int, default=12, help='Number of rotations encoded in the rotation equivariant network.')
        self.parser.add_argument('--rot_augmentation', type=bool, default=True, help='')
    ...
    def parse(self):
        ...
        assert '2d' == self.opt.rot_equivariant_mode
